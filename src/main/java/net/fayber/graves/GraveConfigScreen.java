...
// GraveConfig#set(String, String), which updates the in-memory config
// and saves it to config/graves.json. In singleplayer the integrated
...
public class GraveConfigScreen extends Screen {
    ...
    // toggle that flips the named boolean config key and saves it
